...
const STRINGS = {
  en: {
    ...
    existing_booking_same_time: (v) => `You already have a reservation for ${v?.when} (Ref #${v?.ref}).`,
    existing_booking_confirm_additional: (v) => `You already have a booking for ${v?.existing}. Would you also like one for ${v?.requested}? Reply **yes** to book both, or send a different time.`,
    cancel_pick_booking: (v) => `You have multiple upcoming bookings:\n${v?.lines || ""}\n\nWhich one should I cancel? Reply with the time (e.g. 9:30 PM) or the ref #.`,
    reschedule_pick_booking: (v) => `You have multiple upcoming bookings:\n${v?.lines || ""}\n\nWhich one should I reschedule? Reply with the time (e.g. 9:30 PM) or the ref #.`,
    modify_pick_booking: (v) => `You have multiple upcoming bookings:\n${v?.lines || ""}\n\nWhich booking should I update? Reply with the time (e.g. 9:30 PM) or the ref #.`,
    ...
    messaging_unavailable_subscription: (v) => `Thanks for reaching out${v?.business ? ` to ${v.business}` : ""}! We're temporarily unable to respond here. Please try again later or contact us directly.`,
    messaging_unavailable_limit: (v) => `Thanks for your message${v?.business ? ` to ${v.business}` : ""}! We can't reply on WhatsApp right now. Please try again later or contact us directly.`,
  ...
  sq: {
    ...
    existing_booking_same_time: (v) => `Keni tashmë një rezervim për ${v?.when} (Ref #${v?.ref}).`,
    existing_booking_confirm_additional: (v) => `Keni tashmë një rezervim për ${v?.existing}. Dëshironi edhe një për ${v?.requested}? Përgjigjuni **po** për të dyja, ose dërgoni një orar tjetër.`,
    cancel_pick_booking: (v) => `Keni disa rezervime të ardhshme:\n${v?.lines || ""}\n\nCilin duhet ta anuloj? Përgjigjuni me orën (p.sh. 21:30) ose ref #.`,
    reschedule_pick_booking: (v) => `Keni disa rezervime të ardhshme:\n${v?.lines || ""}\n\nCilin duhet ta ndryshoj? Përgjigjuni me orën (p.sh. 21:30) ose ref #.`,
    modify_pick_booking: (v) => `Keni disa rezervime të ardhshme:\n${v?.lines || ""}\n\nCilin rezervim duhet ta përditësoj? Përgjigjuni me orën (p.sh. 21:30) ose ref #.`,
    ...
    messaging_unavailable_subscription: (v) => `Faleminderit që na shkruajt${v?.business ? ` te ${v.business}` : ""}! Për momentin nuk mund të përgjigjemi këtu. Të lutem provo sërish më vonë ose na kontakto drejtpërdrejt.`,
    messaging_unavailable_limit: (v) => `Faleminderit për mesazhin${v?.business ? ` te ${v.business}` : ""}! Për momentin nuk mund të përgjigjemi në WhatsApp. Të lutem provo sërish më vonë ose na kontakto drejtpërdrejt.`,
